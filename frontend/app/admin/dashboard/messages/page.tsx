...
export default function AdminMessages() {
  // We tell TypeScript: This is a list of ANY kind of data
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-black mb-10 text-cyan-400 tracking-tighter uppercase">Incoming Transmissions</h1>
        ...
        {messages.length === 0 ? (
          ...
          messages.map((m: any) => (
            <div key={m._id} className="bg-gray-900/80 p-8 rounded-[2rem] border border-white/5 relative overflow-hidden group">
              ...
              <div className="bg-black/40 p-4 rounded-2xl border border-white/5 text-gray-300 italic">
                &quot;{m.message}&quot;
              </div>
            </div>
          ))
